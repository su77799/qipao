 ...
 * @LastEditTime: 2023-08-07 06:21:33
...
<template>
    ...
    <van-cell-group inset>
      ...
      <van-field name="stepper" label="最大人数">
        <template #input>
          <van-stepper v-model="createTeamData.maxNum" max=20 min=2 />
        </template>
      </van-field>
...
createTeamData.value.createUserId = store.state.userData.id;
const onSubmit = () => {
  store.state.teamList.push(createTeamData.value);
  showToast('创建成功');
  router.replace('/team');
}
</script>
